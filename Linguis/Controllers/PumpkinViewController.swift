...
class PumpkinViewController: UIViewController, ARSCNViewDelegate {
...
//
    override func viewDidLoad() {
        ...
        // Create a new scene
        let scene = SCNScene(named: "pumpkin.scn")!
        ...
        if let touch = touches.first {
            ...
            if let hitObject = hitList.first {
                ...
                if node.name == "pumpkin" {
                    ...
                    let source = SCNAudioSource(fileNamed: "Pumpkin_sound.m4a")
